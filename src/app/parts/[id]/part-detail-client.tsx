  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <Link href={`/projects/${part.projectId}/flow`} className="rounded-md bg-blue-600 px-4 py-2 text-sm font-semibold text-white">Редактировать техпроцесс</Link>
      ...
      <InfoCard title="Расширенный маршрут">
        <div className="flex gap-3 overflow-x-auto pb-2">
          {sortOperationsByNumber(operations).map((operation) => {
            ...
            return (
              <Link key={operation.id} href={`/projects/${part.projectId}/flow`} className="min-w-64 rounded-lg border border-blue-200 bg-blue-50 p-4">
